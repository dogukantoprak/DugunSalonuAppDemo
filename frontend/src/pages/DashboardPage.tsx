      ...
      <div className="dashboard-shell">
        <div className="dashboard-top-bar">
          <div className="nav-buttons">
            ...
            <button type="button" className="nav-btn" onClick={() => navigate("/personnel")}>
              Personel
            </button>
            <button type="button" className="nav-btn" onClick={() => navigate("/expenses")}>
              Giderler
            </button>
            <button type="button" className="nav-btn" onClick={() => navigate("/reports")}>
              Raporlar
            </button>
        ...
        <StatsCards calendarData={calendarData} loading={loading} />
        <QuickActions />
